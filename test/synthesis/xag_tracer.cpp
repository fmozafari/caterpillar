...
TEST_CASE("trace simple xag", "[tracetest-1]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 1, false) );
  #endif
...
TEST_CASE("trace simple xag 2", "[tracetest-2]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 2, false) );
  #endif
...
TEST_CASE("trace simple xag 3", "[tracetest-3]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 3, false) );
  #endif
...
TEST_CASE("trace simple xag 4", "[tracetest-4]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 4, false) );
  #endif
...
TEST_CASE("trace simple xag 5", "[tracetest-5]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 5, false) );
  #endif
...
TEST_CASE("trace simple xag 6", "[tracetest-6]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 6, false) );
  #endif
...
TEST_CASE("trace simple xag with codependent xor outputs", "[tracetest-7]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 7, false) );
  #endif
...
TEST_CASE("trace simple xag with reconvergence", "[tracetest-8]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 8, false) );
  #endif
...
TEST_CASE("trace simple xag 9", "[tracetest-9]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 9, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("trace simple xag 10", "[tracetest-10]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 10, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("trace simple xag 11", "[tracetest-11]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 11, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("trace simple xag 12", "[tracetest-12]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 12, false) );
  #endif
  #ifdef USE_Z3
  pebbling_mapping_strategy_params peb_ps;
...
TEST_CASE("trace simple xag 13", "[tracetest-13]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 13, false) );
  #endif
  #ifdef USE_Z3
  pebbling_mapping_strategy_params peb_ps;
...
TEST_CASE("trace XAG and opt weights", "[tracetest-14]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 14, false) );
  #endif
  #ifdef USE_Z3
  pebbling_mapping_strategy_params peb_ps;
  peb_ps.pebble_limit=4;
...
TEST_CASE("trace XAG 15", "[tracetest-15]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 15, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("trace XAG 16", "[tracetest-16]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 16, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("trace XAG 17", "[tracetest-17]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 17, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("trace min depth synthesis XAG-small", "[tracetest-18]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 18, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("trace min depth synthesis XAG-small ", "[tracetest-19]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 19, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("trace min depth synthesis parity buffer", "[tracetest-20]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 20, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("trace min depth included cone", "[tracetest-21]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(test_tracer(xag_method::xag_dfit, 21, false) );
  #endif
  #ifdef USE_Z3
