...
TEST_CASE("synthesize simple xag", "[XAG synthesis]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 1, false) );
  #endif
...
TEST_CASE("synthesize simple xag 2", "[XAG synthesis-2]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 2, false) );
  #endif
...
TEST_CASE("synthesize simple xag 3", "[XAG synthesis-3]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 3, false) );
  #endif
...
TEST_CASE("synthesize simple xag 4", "[XAG synthesis-4]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 4, false) );
  #endif
...
TEST_CASE("synthesize simple xag 5", "[XAG synthesis-5]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 5, false) );
  #endif
...
TEST_CASE("synthesize simple xag 6", "[XAG synthesis-6]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 6, false) );
  #endif
...
TEST_CASE("synthesize simple xag with codependent xor outputs", "[XAG synthesis-7]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 7, false) );
  #endif
...
TEST_CASE("synthesize simple xag with reconvergence", "[XAG synthesis-8]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 8, false) );
  #endif
...
TEST_CASE("synthesize simple xag 9", "[XAG synthesis-9]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 9, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("synthesize simple xag 10", "[XAG synthesis-10]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 10, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("synthesize simple xag using pebbling", "[XAG synthesis-11]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 11, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("pebble simple xag 10", "[XAG synthesis-12]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 12, false) );
  #endif
  #ifdef USE_Z3
  pebbling_mapping_strategy_params peb_ps;
...
TEST_CASE("pebble simple xag 11", "[XAG synthesis-13]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 13, false) );
  #endif
  #ifdef USE_Z3
  pebbling_mapping_strategy_params peb_ps;
...
TEST_CASE("pebbling XAG with weights", "[XAG synthesis-14]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 14, false) );
  #endif
  #ifdef USE_Z3
  pebbling_mapping_strategy_params peb_ps;
  peb_ps.pebble_limit=4;
...
TEST_CASE("min depth synthesis XAG", "[XAG synthesis-15]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 15, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("min depth synthesis XAG-2", "[XAG synthesis-16]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 16, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("min depth synthesis XAG no copies", "[XAG synthesis-17]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 17, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("min depth synthesis XAG-small", "[XAG synthesis-18]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 18, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("min depth synthesis XAG-small ", "[XAG synthesis-19]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 19, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("min depth synthesis parity buffer", "[XAG synthesis-20]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 20, false) );
  #endif
  #ifdef USE_Z3
...
TEST_CASE("min depth included cone", "[XAG synthesis-21]")
{
  ...
  #ifdef USE_iGRAPH
  CHECK(xag_synthesis(xag_method::xag_dfit, 21, false) );
  #endif
  #ifdef USE_Z3
